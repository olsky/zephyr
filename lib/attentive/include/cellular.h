...
struct cellular_ops {
    ...
    /** Read chip manufacturer. */
    int (*manufacturer)(struct cellular *modem, char *buf, size_t len);
    /** Read chip model. */
    int (*model)(struct cellular *modem, char *buf, size_t len);
    /** Read chip revision. */
    int (*revision)(struct cellular *modem, char *buf, size_t len);
    ...
    int (*socket_send)(struct cellular *modem, int connid, const void *buffer, size_t amount, int flags);
    int (*socket_recv)(struct cellular *modem, int connid, void *buffer, size_t length, int flags);
